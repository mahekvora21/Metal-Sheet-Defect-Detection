...
#EasyDict allows to access dict values as attributes
...
def _get_default_config():
    ...
    c.data.sample_submission_path = '../Datasets/caliche/severstal-steel-defect-detection/sample_submission.csv'
    c.data.test_dir = '../Datasets/caliche/severstal-steel-defect-detection/test_images'
    c.data.train_df_path = '../Datasets/caliche/severstal-steel-defect-detection/train.csv'
    c.data.train_dir = '../Datasets/caliche/severstal-steel-defect-detection/train_images'
    c.data.params = edict()
